...
♡=========================================♡
\n`, '[ KANEKI ]');
        logger('Đã xoá Gban, restart, timeout', '[ KANEKI ]');
        logger("Á đù, source code đã bị thay đổi bởi Quyền Kaneki", '[ KANEKI ]');
        logger("Cám ơn đã sử dụng git, tôi là Le Thanh Thien", '[ KANEKI ] ');
    });
}
